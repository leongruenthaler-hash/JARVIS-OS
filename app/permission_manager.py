...
PERMISSION_DEFINITIONS: dict[str, str] = {
    ...
    "reservation": "Jarvis bereitet eine Tischreservierung bei TheFork nur nach Ihrer Bestätigung vor (Datum/Uhrzeit/Personenzahl vorausgefüllt) - reserviert selbst nichts endgültig. Dafür öffnet und liest Jarvis kurz Safari, um echte verfügbare Uhrzeiten zu ermitteln.",
