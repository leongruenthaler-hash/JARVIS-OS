...
// Manuell in JarvisMobile eingebunden (kein SPM) - das
// sherpa-onnx.xcframework/SherpaOnnxC.framework wird direkt ueber
// "Frameworks, Libraries, and Embedded Content" verlinkt, siehe
// project.pbxproj. Xcodes eigenes Clang-Modul-System (immer aktiv, nicht nur
// unter SPM) macht "import SherpaOnnxC" dafuer auch ohne den
// SWIFT_PACKAGE-Build-Flag verfuegbar.
import SherpaOnnxC
